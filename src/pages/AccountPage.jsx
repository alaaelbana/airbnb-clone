...
export default function AccountPage() {
  ...
  function linkClasses(type = null) {
    let classes =
      "rounded-full py-2 px-4 transition-colors duration-300 flex items-center gap-1 ";
    if (type === subpage) {
  ...
  return (
    <div>
      {subpage === "bookings" && id ? null : (
        <nav className="w-full flex flex-wrap justify-center gap-3 my-12">
